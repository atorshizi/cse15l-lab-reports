...
- With similar analysis, we can see in the second command line input we also saved 1 keystroke by typing commands all in one line and potentially 10 more keystrokes everytime we reran the code afterwards.
